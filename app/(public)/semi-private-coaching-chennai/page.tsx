...
import {
  ...
  ArrowRight, ChevronDown, Users, CheckCircle2, Zap, Target,
} from "lucide-react";
...
const WA_MESSAGE = "Hi%20Yos%20Fitness%20Studio!%20I%20would%20like%20to%20enquire%20about%20semi-private%20coaching.";
...
export const metadata: Metadata = {
  title: "Semi-Private Coaching in Chennai — Small Group Training at Yos Fitness Studio, Mylapore",
  description:
    "Semi-private coaching at Yos Fitness Studio, Mylapore. Maximum 4 members per slot. Dedicated coach, personalised attention, structured sessions — more affordable than one-on-one personal training. Call +91 98406 90418.",
  alternates: { canonical: `${SITE_URL}/semi-private-coaching-chennai` },
  openGraph: {
    title: "Semi-Private Coaching in Chennai — Yos Fitness Studio, Mylapore",
    description:
      "Small group coaching with a dedicated coach at Yos Fitness Studio, Mylapore. Max 4 per slot. Personalised attention at a more accessible price than personal training.",
    url: `${SITE_URL}/semi-private-coaching-chennai`,
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Semi-private coaching at Yos Fitness Studio in Mylapore is a small-group training format with a maximum of 4 members per slot. A dedicated coach leads the session, providing personalised attention to each member. The workout is structured and coached — not a generic class format.",
      },
    },
    {
      "@type": "Question",
      name: "How is semi-private coaching different from a regular group class?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Unlike a large group class where individual attention is limited, semi-private coaching at Yos Fitness Studio keeps groups small — maximum 4 people per session. This means your coach can observe and correct your technique, adjust the workout to your level, and give you the kind of individual guidance that is normally only available in one-on-one personal training.",
      },
    },
    {
      "@type": "Question",
      name: "Is semi-private coaching suitable for beginners?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Semi-private coaching at Yos Fitness Studio in Mylapore is suitable for all fitness levels, including beginners. The small group size ensures your coach can teach correct technique and build your foundation properly, even within a group session.",
      },
    },
    {
      "@type": "Question",
      name: "How is semi-private coaching priced compared to personal training?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Semi-private coaching at Yos Fitness Studio is more affordable than one-on-one personal training while still providing dedicated coaching in a small group setting. WhatsApp +91 98406 90418 for current pricing on both options.",
      },
    },
  ],
};
...
const faqs = [
  {
    q: "What is semi-private coaching at Yos Fitness Studio?",
    a: "Semi-private coaching is a small-group training format with a maximum of 4 members per session. A dedicated coach leads the session, giving each member personalised attention within a coached, structured workout — not a generic group class.",
  },
  {
    q: "How is it different from a regular group fitness class?",
    a: "In a large group class, individual attention is limited and coaching is generic. Semi-private coaching at Yos Fitness Studio keeps the group small — maximum 4 people — so your coach can correct your technique, adjust the workout to your level, and give you the kind of attention normally reserved for one-on-one training.",
  },
  {
    q: "Is semi-private coaching suitable for beginners?",
    a: "Yes. The small group format means your coach can spend time teaching correct technique even within a group session. Beginners get proper coaching from day one, and the programme is appropriate for your current fitness level.",
  },
  {
    q: "How is semi-private coaching priced compared to personal training?",
    a: `Semi-private coaching is more affordable than one-on-one personal training while still providing dedicated coaching in a small group. WhatsApp us on ${PHONE_DISPLAY} for current pricing on both options.`,
  },
];
...
export default function SemiPrivateCoachingChennaiPage() {
        ...
        <section className="relative bg-gray-950 overflow-hidden" aria-labelledby="hero-heading">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            <div className="inline-flex items-center gap-2 bg-red-600/15 border border-red-600/25 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-red-400 text-xs font-semibold tracking-wide">Max 4 per slot · Mylapore, Chennai</span>
            </div>
            <h1 id="hero-heading" className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-[1.1] tracking-tight max-w-4xl">
              Semi-Private Coaching in Chennai —{" "}
              <span className="text-red-500">Small Group Training</span>{" "}
              at Yos Fitness Studio, Mylapore
            </h1>
            <p className="mt-6 text-gray-400 text-lg sm:text-xl leading-relaxed max-w-2xl">
              Get the personal attention of coached training in a small group of up to 4 people. A dedicated coach leads every session — with the focus, technique guidance, and structure of one-on-one coaching, at a more accessible price.
            </p>
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <a href={waLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-bold text-base px-8 py-4 rounded-2xl shadow-xl shadow-red-900/40 transition-all">
                ...
                Enquire About Semi-Private Coaching
              </a>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight">
                What Makes Semi-Private Coaching Different
              </h2>
              <p className="mt-5 text-gray-600 text-lg leading-relaxed">
                Semi-private coaching at Yos Fitness Studio in Mylapore sits between one-on-one personal training and a standard group class. You train in a small group of up to 4 people with a dedicated coach — getting real coaching attention, not just a shared workout.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Users, title: "Maximum 4 Per Session", desc: "Sessions are capped at 4 members to ensure your coach can give each person meaningful attention and technique feedback — not just supervise from a distance." },
                { icon: Target, title: "Dedicated Coach for Every Session", desc: "A coach leads every session with a clear structure. This is not an unsupervised workout — it is coached training in a small group format." },
                { icon: Zap, title: "Personalised Within the Group", desc: "Your coach adjusts the workout to each member's level and goal. The group trains together, but the guidance is individual." },
                { icon: CheckCircle2, title: "More Affordable Than 1-on-1 PT", desc: "Semi-private coaching delivers the coaching quality of personal training at a more accessible price point — making coached fitness available to more people." },
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <p className="text-red-600 text-sm font-bold uppercase tracking-widest mb-3">How It Compares</p>
              <h2 className="text-3xl font-extrabold text-gray-900">Semi-Private vs Other Options</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { label: "Large Group Class", points: ["Generic workout for all", "Limited individual attention", "No technique correction", "No personalised programming"], highlight: false },
                { label: "Semi-Private Coaching", points: ["Max 4 per session", "Dedicated coach throughout", "Technique feedback for each member", "Programme adjusted to your level"], highlight: true },
                { label: "One-on-One PT", points: ["Full individual attention", "Entirely customised programme", "Maximum coaching focus", "Higher investment per session"], highlight: false },
              ].map(({ label, points, highlight }) => (
                <div key={label} className={`rounded-2xl p-6 border ${highlight ? "bg-red-600 border-red-500 shadow-xl" : "bg-white border-gray-100"}`}>
                  <h3 className={`font-bold text-lg mb-4 ${highlight ? "text-white" : "text-gray-900"}`}>{label}</h3>
                  <ul className="space-y-2">
                    {points.map((p) => (
                      <li key={p} className={`flex items-start gap-2 text-sm ${highlight ? "text-white/90" : "text-gray-600"}`}>
                        <CheckCircle2 className={`h-4 w-4 flex-shrink-0 mt-0.5 ${highlight ? "text-white" : "text-red-500"}`} aria-hidden="true" />
                        {p}
                      </li>
                    ))}
                  </ul>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-extrabold text-gray-900">Semi-Private Coaching — Questions Answered</h2>
            </div>
        ...
        <section className="py-20 bg-red-600 relative overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white leading-tight">
              Interested in Semi-Private Coaching at Yos Fitness Studio?
            </h2>
            <p className="mt-4 text-red-100 text-lg">
              WhatsApp or call us to find out about availability, pricing, and how to get started with semi-private coaching in Mylapore, Chennai.
            </p>
