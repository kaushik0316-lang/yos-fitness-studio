...
const DASHBOARD_URL = "https://yosfitnessstudio.in/staff-dashboard";

export default function StaffDashboardPosterPage() {
  return (
    <>
        ...
        >
          ...
          <div>
            ...
            <h1 className="text-white font-black text-3xl uppercase tracking-tight leading-tight">
              Scan to Open<br />Staff Dashboard
            </h1>
          </div>
          ...
          <div>
            ...
            <p className="text-orange-400 text-sm font-bold tracking-wide">
              yosfitnessstudio.in/staff-dashboard
            </p>
          </div>
          ...
          <div className="space-y-1.5">
            <p className="text-gray-400 text-xs leading-relaxed">
              Scan with your phone camera to access<br />
              the staff dashboard. Enter your PIN to sign in.
            </p>
