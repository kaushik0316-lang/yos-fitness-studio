...
export default function MemberCheckinPosterPage() {
  return (
    <>
      <div className="no-print fixed top-4 right-4 z-50">
        <button
          onClick={() => window.print()}
          className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold px-5 py-2.5 rounded-xl shadow-lg transition-colors text-sm"
        >
      ...
      <div className="poster min-h-screen flex items-center justify-center p-8" style={{ background: "#0c0c0c" }}>
        <div
          className="poster-card w-full max-w-sm mx-auto rounded-3xl p-10 flex flex-col items-center gap-8 text-center"
          style={{
            background: "linear-gradient(160deg, #161616 0%, #0c1108 100%)",
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3">
            <Image src="/Logo.png" alt="Yos Fitness Studio" width={72} height={72} className="h-16 w-auto object-contain" />
            <div>
              <p className="text-white font-black text-xl uppercase tracking-widest leading-none">Yos Fitness Studio</p>
              <p className="text-green-400/60 text-xs uppercase tracking-[0.2em] mt-1">Mylapore, Chennai</p>
            </div>
          </div>

          <div className="w-full h-px" style={{ background: "rgba(34,197,94,0.15)" }} />
          ...
          <div className="p-5 rounded-2xl" style={{ background: "#ffffff" }}>
            <QRCode value={CHECKIN_URL} size={200} bgColor="#ffffff" fgColor="#111111" level="H" />
          </div>
          ...
          <div className="space-y-1.5">
            <p className="text-gray-400 text-xs leading-relaxed">
              Scan with your phone camera and enter<br />your 4-digit PIN to mark your attendance.
            </p>
            <p className="text-gray-600 text-[10px] uppercase tracking-widest">Mark attendance every visit</p>
          </div>
        </div>
      </div>
      ...
      <style jsx global>{`
        @media print {
          ...
          .poster { min-height: 100vh; background: #0c0c0c !important; display: flex; align-items: center; justify-content: center; }
