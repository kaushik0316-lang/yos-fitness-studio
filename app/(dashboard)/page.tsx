      ...
      <div className="min-h-screen bg-white font-sans">
        ...
        <section id="hero" className="relative bg-stone-950 overflow-hidden" aria-labelledby="hero-heading">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 lg:py-36">
            ...
            <h1 id="hero-heading" className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-[1.1] tracking-tight max-w-4xl">
              Yos Fitness Studio —{" "}
              <span className="text-red-400">Your Neighbourhood Gym</span>{" "}
              in Mylapore
            </h1>
        ...
        <section id="reviews" className="py-20 bg-white">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight">Already Training With Us?</h2>
            <p className="mt-4 text-gray-600 text-lg leading-relaxed">Leave us a Google review — it helps more people in Mylapore find proper fitness coaching.</p>
            <div className="mt-8">
              <a href={GOOGLE_REVIEW_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2.5 bg-gray-900 hover:bg-gray-800 text-white font-bold text-base px-8 py-4 rounded-2xl shadow-lg transition-all">
                ...
                Review Yos Fitness Studio on Google
              </a>
            </div>
            <p className="mt-5 text-gray-400 text-sm">Your reviews help more people in Mylapore find proper fitness coaching.</p>
          </div>
        </section>
