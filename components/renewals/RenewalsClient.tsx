            ...
            <div className="w-full max-w-md rounded-3xl overflow-hidden"
              ...
              <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">{selectedList.length} members — click each to open chat</p>
                </div>
              ...
              <div className="overflow-y-auto" style={{ maxHeight: "calc(80vh - 80px)" }}>
                {selectedList.map((ms) => {
                  ...
                  const waHref = phone ? `https://wa.me/91${phone}?text=${encodeURIComponent(msg)}` : null;
                  const expStr = ms.expiryDate ? formatDate(ms.expiryDate) : "—";
                  return (
                    <div key={ms.id} className="flex items-center gap-3 px-5 py-3.5 border-b border-white/5 hover:bg-white/[0.03] transition-colors">
                      <div className="flex-1 min-w-0">
