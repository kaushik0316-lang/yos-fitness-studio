          ...
          {birthdayMembers.length === 0 ? (
            ...
            <div className="divide-y divide-white/5">
              {birthdayMembers.map((m) => {
                ...
                return (
                  <div key={m.id} className="flex items-center gap-3 px-5 py-4 hover:bg-white/[0.02] transition-colors">
                    ...
                    {phone && (
                      <a href={`https://wa.me/91${phone}?text=${encodeURIComponent(bdayMsg)}`}
                        ...
                        className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-bold flex-shrink-0"
