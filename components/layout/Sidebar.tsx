...
import {
  ...
  Settings, LogOut, Wrench, FileUp, UserSearch, TrendingUp, Trophy, Search, MessageSquare, Megaphone, Send,
} from "lucide-react";
...
const navGroups = [
  {
    ...
    items: [
      ...
      { label: "Challenge",        href: "/challenge",          icon: Trophy,        roles: ["ADMIN", "FRONT_DESK", "TRAINER"] },
      ...
      { label: "Outreach",          href: "/outreach",           icon: Send,          roles: ["ADMIN", "FRONT_DESK"] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Templates",        href: "/settings/templates", icon: MessageSquare, roles: ["ADMIN"] },
      { label: "Announcements",    href: "/announcements",      icon: Megaphone,     roles: ["ADMIN"] },
